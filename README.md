...
## 🔀 与上游 Readest 分道扬镳声明（v8.23.2 起）

**自 v8.23.2 起，Readest Lite 不再与上游 [readest/readest](https://github.com/readest/readest) 自动同步。**
...
### 用户建议
- 想要上游最新功能的用户：请使用官方 [readest/readest](https://github.com/readest/readest) 或其云服务。
