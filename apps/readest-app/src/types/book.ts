...
export interface Book {
  ...
  filePath?: string;
  /** v0.12.1: Alternative file paths for the same book (deduped during import) */
  altFilePaths?: string[];
  ...
  duration?: number;
  // v0.12.6: ABS podcast show stub marker (undefined = regular audiobook)
  absMediaType?: 'podcast';
  // v0.12.6: Episode count for ABS podcast show stub
  episodeCount?: number;
