...
const description =
  'Discover Readest Lite, the self-hostable online ebook reader for immersive and organized reading. ' +
...
const previewImage = 'https://cshdotcom.github.io/readestl/og.png';
...
export const metadata: Metadata = {
  ...
  keywords: ['epub', 'pdf', 'ebook', 'reader', 'readest', 'readest-lite', 'pwa', 'self-hosted'],
  authors: [
    {
      name: 'readest-lite',
